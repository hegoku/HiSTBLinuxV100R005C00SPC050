...
sed -i 's/linux-4\.9\.329/linux-4\.19\.322/g' ${DIST_DIR}/.gitignore

sed -i 's/linux-4\.9\.329/linux-4\.19\.322/g' ${DIST_DIR}/scripts/kconfig/Kconfig.kernel
sed -i 's/LINUX-4\.9\.329/LINUX-4\.19\.322/g' ${DIST_DIR}/scripts/kconfig/Kconfig.kernel
