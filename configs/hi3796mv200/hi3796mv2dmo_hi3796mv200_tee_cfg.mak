...
CFG_HI_OUT_DIR=hi3796mv200dmo_tee
...
# CFG_HI_TUNER4_DEV_TYPE_CXD2861 is not set
...
# CFG_HI_DEMOD4_DEV_TYPE_3138 is not set
...
# CFG_HI_TUNER5_DEV_TYPE_CXD2861 is not set
...
# CFG_HI_DEMOD5_DEV_TYPE_3138 is not set
...
# CFG_HI_TUNER6_DEV_TYPE_CXD2861 is not set
...
# CFG_HI_DEMOD6_DEV_TYPE_3138 is not set
...
# CFG_HI_DEMUX_INVALID_PES_DROP_SUPPORT is not set
...
CFG_HI_TEE_KLAD_SUPPORT=y
CFG_HI_TEE_PVR_SUPPORT=y
CFG_HI_TEE_DEMUX_SUPPORT=y
CFG_HI_TEE_PLCIPHER_SUPPORT=y
CFG_HI_TEE_HDMI_SUPPORT=y
# CFG_HI_TEE_DEMO_SUPPORT is not set
# CFG_HI_TEE_TEST_SUPPORT is not set
CFG_HI_TEE_TA_LOAD_SUPPORT=y
CFG_HI_TEE_PM_SUPPORT=y
CFG_HI_TEE_VDP_SUPPORT=y

#
# vdp feature select
#
CFG_HI_TEE_VDP_VERIMATRIX_SUPPORT=y
CFG_HI_TEE_VDP_NEXTGUARD_SUPPORT=y
# CFG_HI_TEE_VDP_CHINADRM_SUPPORT is not set
CFG_HI_TEE_VDP_ANALOGOUTPUT_CTRL_SUPPORT=y
# CFG_HI_TEE_WIDEVINE_SUPPORT is not set
# CFG_HI_TEE_PLAYREADY_SUPPORT is not set
# CFG_HI_TEE_CRYPTOEN_SUPPORT is not set
# CFG_HI_TEE_SM_SUPPORT is not set
CFG_HI_TEE_MAILBOX_SUPPORT=y
